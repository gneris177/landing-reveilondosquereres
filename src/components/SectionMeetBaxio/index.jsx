          ...
          <div style={{ position: 'relative' }}>
            <div className="wrapper-ingresse">
              <p className="wrapper-ingresse__text">
                Diferente de tudo que você já viveu! Seja bem-vindo ao Réveillon
                dos Quereres 2024, que estreia em Baixio. Localizado a pouco
                mais de uma hora de Salvador, próximo à Praia do Forte e à Costa
                do Sauípe. Com suas águas cristalinas do mar, rio e lagoas,
                Baixio se torna um verdadeiro refúgio para aqueles que são
                apaixonados pela natureza. O Réveillon promete muitas emoções do
                dia 28 a 31/12 com atrações incríveis, eventos Open Bar e uma
                vibe única!
              </p>
              <div className="wrapper-ingresse__button">
                ...
                <img
                  src={logoIngresse}
                  className="logo-ingresse"
                  alt="logo da ingresse"
                />
              </div>
            </div>

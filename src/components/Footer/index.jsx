...
const Footer = () => {
  return (
    <footer className="footer">
          ...
          <div className="info">
            <div>
              <img
                ...
                src={logoBaixio}
                alt="logomarca da empresa Baixio"
              />
              ...
              <div className="info__text">
                <img
                  width="20"
                  height="20"
                  src="https://img.icons8.com/metro/50/filled-message.png"
                  alt="filled-message"
                />
              ...
              <div className="info__text">
                ...
                <a
                  rel="noopener noreferrer"
                  href="https://api.whatsapp.com/send?phone=5571999665493&text=Ol%C3%A1!%20Eu%20queria%20mais%20informa%C3%A7%C3%B5es%20sobre%20a%20Baixio%20Turismo"
                  target="_blank"
                >
                  <img
                    width="22"
      ...
      <footer className="footer__footer" id="contact">
        <Container>
          <div className="footer__footer__content">
            <p>
              © 2023 <strong>Baixio Turismo LTDA</strong>. Todos os direitos
              reservados.
            </p>
            <img
              className="logo-pira"
              src={piraLogo}
              alt="logomarca da agência Pira"
            />
          </div>
        </Container>
      </footer>
